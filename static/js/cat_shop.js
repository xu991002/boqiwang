...
function shop(type_id = 1) {
    axios.get('http://localhost:3000/cat_shop', {
        params: {
            type_id
        }
    }).then(res => {
...
function shop_one(type_id = 11) {
    axios.get('http://localhost:3000/cat_shop_one', {
        params: {
            type_id
        }
    }).then(res => {
...
function shop_two(type_id = 21) {
    axios.get('http://localhost:3000/cat_shop_two', {
        params: {
            type_id
        }
    }).then(res => {
...
function shop_three(type_id = 31) {
    axios.get('http://localhost:3000/cat_shop_three', {
        params: {
            type_id
        }
    }).then(res => {
...
function shop_four(type_id = 41) {
    axios.get('http://localhost:3000/cat_shop_four', {
        params: {
            type_id
        }
    }).then(res => {
